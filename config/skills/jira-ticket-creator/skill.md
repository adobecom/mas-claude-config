...
description: Create Jira tickets in the MWPW project using corp-jira MCP. Handles required fields (team, component, issue type) automatically. Use when user wants to create a Jira ticket, task, story, or bug.
